...
const lv: Translation = {
  ...
  status: {
    ...
    warnings: {
      ...
      fxFallbackToCurrent: '[{{date}}] Nav pieejams vēsturiskais USD/EUR kurss — EUR vērtība šim darījumam aplēsta pēc šodienas kursa.',
      fxFallbackToCurrentTicker: '[{{date}}] Nav pieejams vēsturiskais USD/EUR kurss — EUR vērtība šim {{ticker}} darījumam aplēsta pēc šodienas kursa.',
      fxRatesUnavailable_zero: 'Vēsturiskie USD/EUR kursi nav pieejami; {{count}} darījumu novērtēti pēc šodienas kursa. EUR skaitļi ir aptuveni.',
      fxRatesUnavailable_one: 'Vēsturiskie USD/EUR kursi nav pieejami; {{count}} darījums novērtēts pēc šodienas kursa. EUR skaitļi ir aptuveni.',
      fxRatesUnavailable_other: 'Vēsturiskie USD/EUR kursi nav pieejami; {{count}} darījumi novērtēti pēc šodienas kursa. EUR skaitļi ir aptuveni.',
    },
