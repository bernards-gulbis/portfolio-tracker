...
const lv: Translation = {
  ...
  app: {
    ...
    footer: {
      ...
      dataAttribution: 'Dati no <provider>Yahoo Finance</provider>',
  ...
  transaction: {
    fxNeededBadge: 'Nepieciešams kurss',
    fxNeededHelp: 'Šim datumam nav vēsturiskā USD/EUR kursa — atveriet šo darījumu un norādiet EUR summu vai valūtas kursu, lai EUR aprēķini to iekļautu.',
    toasts: {
    ...
    modal: {
      ...
      fields: {
        ...
        fee: 'Komisija',
        totalAmount: 'Kopējā summa',
        totalAmountEurHint: '≈ {{eur}} EUR (kurss 1 EUR = {{rate}} USD)',
    ...
    csv: {
      ...
      previewTitle: 'Apstipriniet importu',
      previewIntro: 'Lūk, ko mēs darīsim. Apstipriniet, lai veiktu importu, vai dodieties atpakaļ, lai izvēlētos citu failu.',
      previewWillImport_zero: 'Netiks pievienoti jauni darījumi — visas rindas jau pastāv šajā portfelī.',
      previewWillImport_one: 'Tiks pievienots {{count}} jauns darījums.',
      previewWillImport_other: 'Tiks pievienoti {{count}} jauni darījumi.',
      previewWillSkip_one: 'Tiks izlaista {{count}} dublikāta rinda.',
      previewWillSkip_other: 'Tiks izlaistas {{count}} dublikātu rindas.',
      back: 'Atpakaļ',
      confirmImport: 'Apstiprināt importu',
    },
  },
  status: {
    ...
    updatedRelative: 'Atjaunināts {{relative}}',
    justNow: 'tikko',
    minutesAgo_one: 'pirms {{count}} min',
    minutesAgo_other: 'pirms {{count}} min',
    hoursAgo_one: 'pirms {{count}} h',
    hoursAgo_other: 'pirms {{count}} h',
    daysAgo_one: 'pirms {{count}} d',
    daysAgo_other: 'pirms {{count}} d',
    freshness: {
      live: 'Tiešraide',
      stale: 'Novecojis',
      error: 'Bezsaistē',
    ...
    warnings: {
      ...
      fxRateMissing: '[{{date}}] Šim darījumam nav pieejams vēsturiskais USD/EUR kurss — norādiet EUR summu vai valūtas kursu, lai iekļautu to EUR aprēķinos.',
      fxRateMissingTicker: '[{{date}}] Šim {{ticker}} darījumam nav pieejams vēsturiskais USD/EUR kurss — norādiet EUR summu vai valūtas kursu, lai iekļautu to EUR aprēķinos.',
      fxRatesUnavailable_zero: 'Vēsturiskie USD/EUR kursi nav pieejami; {{count}} darījumiem nepieciešama EUR summa vai valūtas kurss. EUR skaitļi ir nepilnīgi, līdz tie tiks norādīti.',
      fxRatesUnavailable_one: 'Vēsturiskie USD/EUR kursi nav pieejami; {{count}} darījumam nepieciešama EUR summa vai valūtas kurss. EUR skaitļi ir nepilnīgi, līdz tas tiks norādīts.',
      fxRatesUnavailable_other: 'Vēsturiskie USD/EUR kursi nav pieejami; {{count}} darījumiem nepieciešama EUR summa vai valūtas kurss. EUR skaitļi ir nepilnīgi, līdz tie tiks norādīti.',
    },
    ...
    today: 'šodien',
    todayColumn: 'Šodien',
    dayChangePartialNote: 'Dažas pozīcijas izslēgtas — nav pieejama iepriekšējās dienas cena.',
    vsSp500: 'pret S&P 500',
    vsSp500Tooltip: 'Procentpunktu starpība starp jūsu portfeļa kopējo ienesību un S&P 500 kopējo ienesību tajā pašā periodā. Pozitīvs skaitlis nozīmē, ka portfelis pārsniedz indeksu redzamajā diagrammas logā.',
    points: 'p.p.',
    outperform: 'Pārsniedz',
    underperform: 'Atpaliek',
    percentOfPortfolio: '% no portfeļa',
    cashRow: 'Nauda',
    holdingsCount_one: '{{count}} pozīcija · {{total}}',
    holdingsCount_other: '{{count}} pozīcijas · {{total}}',
    realizedGainsSummary_one: '{{total}} ({{count}} pārdošana)',
    realizedGainsSummary_other: '{{total}} ({{count}} pārdošanas)',
    dividendsSummary_one: '{{total}} ({{count}} maksājums)',
    dividendsSummary_other: '{{total}} ({{count}} maksājumi)',
    withdrawalsSummary_one: '{{total}} ({{count}} izņemšana)',
    withdrawalsSummary_other: '{{total}} ({{count}} izņemšanas)',
    afterTaxTooltip: 'Hipotētiska vērtība, pieņemot, ka šodien pārdotu visas pozīcijas un samaksātu {{rate}}% no kapitāla peļņas. Latvijas nodokļu likumi īstermiņa, ilgtermiņa un dividenžu ienākumus aplūko atšķirīgi — uzskatiet to par rādītāju, nevis nodokļu deklarācijas summu.',
    ...
    totalReturnTooltip: 'Nerealizētā un realizētā peļņa plus dividendes, kopš pirmā darījuma. Apakšrindā — gada likme.',
    scopeSinceYear: 'Kopš {{year}}',
    annualized: 'Gada',
    ...
    chartCostBasisFallback: 'Nav vēsturisko cenu datu šiem instrumentiem: {{tickers}}. Diagramma šīs pozīcijas vērtē pēc iegādes vērtības (plakana līnija) — faktiskā tirgus vērtība var atšķirties.',
    chartWarningsButton: 'Diagrammas piezīmes',
    on: 'no',
    ...
    priceCaption: 'cena',
    pricePerShare: '{{amount}} / akcija',
    ofPurchased: 'no {{total}} iegādātām',
