...
const lv: Translation = {
  ...
  status: {
    ...
    vsSp500Tooltip: 'Jūsu portfeļa laika svērtā ienesība mīnus S&P 500 ienesība tajā pašā periodā, izteikta procentpunktos (p.p.). Pozitīvs skaitlis nozīmē, ka portfelis pārsniedz indeksu redzamajā diagrammas logā.',
    points: 'p.p.',
