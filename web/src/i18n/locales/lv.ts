...
const lv: Translation = {
  ...
  status: {
    ...
    historySummary: {
      sales_one: '{{count}} pārdošana',
      sales_other: '{{count}} pārdošanas',
      dividends_one: '{{count}} dividende',
      dividends_other: '{{count}} dividendes',
      withdrawals_one: '{{count}} izņemšana',
      withdrawals_other: '{{count}} izņemšanas',
    },
