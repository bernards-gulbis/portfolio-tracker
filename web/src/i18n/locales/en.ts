const en = {
  ...
  transaction: {
    ...
    modal: {
      ...
      fields: {
        ...
        futureDateWarning: 'This date is in the future.',
        time: 'Time',
        ...
        fee: 'Fee',
        totalAmount: 'Total Amount',
        totalAmountEurHint: '≈ {{eur}} EUR @ 1 EUR = {{rate}} USD',
  ...
  status: {
    ...
    today: 'today',
    todayColumn: 'Today',
    dayChangePartialNote: 'Some holdings are excluded — prior close unavailable.',
    vsSp500: 'vs S&P 500',
    vsSp500Tooltip: 'Difference (in percentage points) between your portfolio total return % and the S&P 500 total return % over the same period. Positive means you outperformed the index over the visible chart window.',
    points: 'pp',
    outperform: 'Outperform',
    underperform: 'Underperform',
    percentOfPortfolio: '% Portfolio',
    cashRow: 'Cash',
    holdingsCount_one: '{{count}} holding · {{total}}',
    holdingsCount_other: '{{count}} holdings · {{total}}',
    realizedGainsSummary_one: '{{total}} ({{count}} sale)',
    realizedGainsSummary_other: '{{total}} ({{count}} sales)',
    dividendsSummary_one: '{{total}} ({{count}} payment)',
    dividendsSummary_other: '{{total}} ({{count}} payments)',
    withdrawalsSummary_one: '{{total}} ({{count}} withdrawal)',
    withdrawalsSummary_other: '{{total}} ({{count}} withdrawals)',
    afterTaxTooltip: 'Hypothetical balance assuming you sold every holding today and paid {{rate}}% on capital gains. Latvian tax law treats short-term, long-term, and dividend income differently — treat this as an indicator, not a filing figure.',
    ...
    chartWarningsButton: 'Chart notes',
    on: 'on',
    ...
    priceCaption: 'price',
    pricePerShare: '{{amount}} / share',
    ofPurchased: 'of {{total}} purchased',
    allSold: 'all sold',
    ofTotal: 'of {{total}}',
