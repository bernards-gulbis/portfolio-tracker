const en = {
  ...
  status: {
    ...
    vsSp500: 'vs S&P 500',
    vsSp500Tooltip: 'Your portfolio\'s time-weighted return minus the S&P 500\'s return over the same period, in percentage points (pts). Positive means you outperformed the index over the visible chart window.',
    points: 'pts',
