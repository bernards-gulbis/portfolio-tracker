const en = {
  ...
  status: {
    ...
    warnings: {
      ...
      fxFallbackToCurrent: "[{{date}}] No historical USD/EUR rate available — EUR value for this transaction was estimated using today's rate.",
      fxFallbackToCurrentTicker: "[{{date}}] No historical USD/EUR rate available — EUR value for this {{ticker}} transaction was estimated using today's rate.",
      fxRatesUnavailable_zero: "Historical USD/EUR rates are unavailable; {{count}} transactions have been valued using today's rate. EUR figures are approximate.",
      fxRatesUnavailable_one: "Historical USD/EUR rates are unavailable; {{count}} transaction has been valued using today's rate. EUR figures are approximate.",
      fxRatesUnavailable_other: "Historical USD/EUR rates are unavailable; {{count}} transactions have been valued using today's rate. EUR figures are approximate.",
    },
