  ...
  return (
    ...
    >
      ...
      <div className="grid gap-1.5">
        {payload
          .filter((item: RechartsPrimitive.TooltipPayloadEntry<ValueType, NameType>) => item.type !== "none")
          .map((item: RechartsPrimitive.TooltipPayloadEntry<ValueType, NameType>, index: number) => {
