...
def upgrade() -> None:
    ...
    with op.batch_alter_table("historical_prices", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_historical_prices_ticker"), ["ticker"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column(
            "picture", sqlmodel.sql.sqltypes.AutoString(length=2048), nullable=True
        ),
    ...
    with op.batch_alter_table("oauthaccount", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_oauthaccount_account_id"), ["account_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_oauthaccount_oauth_name"), ["oauth_name"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_oauthaccount_user_id"), ["user_id"], unique=False
        )
    ...
    with op.batch_alter_table("portfolio", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_portfolio_user_id"), ["user_id"], unique=False
        )
    ...
    with op.batch_alter_table("transaction", schema=None) as batch_op:
        batch_op.create_index(
            "ix_transaction_portfolio_date", ["portfolio_id", "date"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_transaction_portfolio_id"), ["portfolio_id"], unique=False
        )
